...
class Quittance(db.Model):
    ...
    # Tsy atao unique=True intsony eto mba ahafahana mandray ny paiement partiel (quittance iray miverina)
    quittance_num = db.Column(db.String(100), nullable=False, index=True)
    ...
    date_encaissement = db.Column(db.String(50), nullable=True)
...
class HistoriqueDocument(db.Model):
    ...
    date_import = db.Column(db.String(50), nullable=False)
